    ...
    setup(props, { emit }) {
      ...
      const confirmRename = () => {
        if (newName.value && renamingItem.value) {
          ...
          showToast({ msg: 'Renamed successfully', type: 'success' })
        }
        cancelRename()
      }
      ...
      const duplicateItem = (item) => {
        ...
        showToast({ msg: 'Duplicated successfully', type: 'success' })
      }
      ...
      const deleteItem = (item) => {
        ...
        if (index > -1) {
          ...
          selectedItems.value.delete(item.id)
          showToast({ msg: 'Deleted successfully', type: 'success' })
        }
      }
      ...
      const deleteSelected = () => {
        ...
        selectedItems.value.clear()
        showToast({ msg: `Deleted ${count} items`, type: 'success' })
      }
